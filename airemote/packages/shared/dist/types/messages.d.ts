...
export type WSMessageType = 'agent:register' | 'agent:heartbeat' | 'agent:stats' | 'agent:status' | 'agent:command_result' | 'server:registered' | 'server:command' | 'server:error' | 'client:subscribe' | 'client:command' | 'client:ai_chat' | 'broadcast:device_update' | 'broadcast:stats_update';
